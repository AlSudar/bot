...
async def handle_action_service_garanty(query: CallbackQuery, action_type: SectionData, context: ContextTypes.DEFAULT_TYPE, callback: Callable[
    ...
    'work_performed': {
        'text': 'Чтобы мы смогли урегулировать ситуацию, касающуюся ремонта Вашего автомобиля VOYAH, напишите нашей поддержке {HELPER_BOT_USERNAME} и укажите Ваше имя, контактный номер телефона, VIN автомобиля, в какой дилерский центр Вы обращались, а также опишите Ваш вопрос',
