...
async def handle_action_multimedia_i_po(query: CallbackQuery, action_type: str, context: ContextTypes.DEFAULT_TYPE, callback: Callable[
   ...
   messages = {
    ...
    'passions_last_versions_yourself': {
		'text': 'Чтобы узнать, какая версия ПО установлена в мультимедийной системе Вашего VOYAH, перейдите в настройки - система. Во второй части названия "Версия программного обеспечения" указана установленная версия, например: 2.5.33.4-20240815173729. То есть 2.5.33.4-20240815173729 и есть версия ПО в указанном случае.',
